...
public class StandaloneTestTest extends StandaloneTest {
    ...
    public void setUp() throws Exception {
        ...
        System.setProperty(Configuration.URL, "http://localhost:8080/jsunit/testRunner.html?testPage=http://localhost:8080/jsunit/tests/jsUnitTestSuite.html&autoRun=true&submitresults=true&resultId=foobar");
        super.setUp();
    }
