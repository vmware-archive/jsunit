...
public class TestCaseResultTest extends TestCase {
    ...
    public void testBuildErrorResultFromString() {
        ...
        assertEquals("<testcase name=\"file:///dummy/path/dummyPage.html:testFoo\" time=\"1.3\"><error message=\"Test Error Message\" /></testcase>", result.getXmlFragment());
    }
    ...
    public void testBuildFailureResultFromString() {
        ...
        assertEquals("<testcase name=\"file:///dummy/path/dummyPage.html:testFoo\" time=\"1.3\"><failure message=\"Test Failure Message\" /></testcase>", result.getXmlFragment());
    }
