...
public class TestRunServiceClientTest extends TestCase {
    ...
    public void testSimple() throws Exception {
        ...
        TestRunServiceClient client = new TestRunServiceClient("http://www.example.com/jsUnitService", mockLocator, "a username", "a password");
    ...
    public void testBadServiceURL() throws Exception {
        TestRunServiceClient client = new TestRunServiceClient("not a url", new TestRunServiceServiceLocator(), "username", "password");
        try {
