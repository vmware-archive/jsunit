...
public class RunnerServiceAggregateServerFunctionalTest extends AggregateServerFunctionalTestCase {
    ...
    private TestRunResult result1() {
        ...
        testRunResult.setUrl(FunctionalTestAggregateConfigurationSource.REMOTE_SERVER_URL_1);
        return testRunResult;
    }

    private TestRunResult result2() {
        TestRunResult testRunResult = new TestRunResult();
        ...
        testRunResult.setUrl(FunctionalTestAggregateConfigurationSource.REMOTE_SERVER_URL_2);
        return testRunResult;
    }
