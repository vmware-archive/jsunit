...
public class PreferenceInitializer extends AbstractPreferenceInitializer {
	...
	public void initializeDefaultPreferences() {
		...
		store.setDefault(PreferenceConstants.PREFERENCE_CLOSE_BROWSERS_AFTER_TEST_RUNS, 
			Boolean.valueOf(ConfigurationProperty.CLOSE_BROWSERS_AFTER_TEST_RUNS.getDefaultValue()));
		store.setDefault(PreferenceConstants.PREFERENCE_TEST_PAGE_EXTENSIONS, "html,htm");
		store.setDefault(PreferenceConstants.PREFERENCE_TIMEOUT_SECONDS, 
			ConfigurationProperty.TIMEOUT_SECONDS.getDefaultValue());
		store.setDefault(PreferenceConstants.PREFERENCE_LOG_STATUS, 
			Boolean.valueOf(ConfigurationProperty.LOG_STATUS.getDefaultValue()));
	}
